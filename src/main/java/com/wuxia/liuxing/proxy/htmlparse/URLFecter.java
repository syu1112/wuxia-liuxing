package com.wuxia.liuxing.proxy.htmlparse;
...
public class URLFecter {
    ...
    //使用代理IP爬取xici代理网站的第一页
    public static List<IPMessage> urlParse(List<IPMessage> ipMessages, String ip, String prot) {
        String url = "http://www.xicidaili.com/nn/1";
        String html = MyHttpResponse.getHtml(url, ip, prot);
